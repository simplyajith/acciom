...
Revision ID: 75312c59c465
Revises: 
Create Date: 2019-07-22 15:40:23.237565
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('org_id', 'group_id', 'permission_id')
    )
    op.create_index(op.f('ix_group_permission_group_id'), 'group_permission', ['group_id'], unique=False)
    op.create_index(op.f('ix_group_permission_org_id'), 'group_permission', ['org_id'], unique=False)
    op.create_index(op.f('ix_group_permission_permission_id'), 'group_permission', ['permission_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['project_id'], ['project.project_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], ),
    sa.PrimaryKeyConstraint('user_id', 'org_id', 'project_id', 'group_id')
    )
    ...
    op.create_index(op.f('ix_user_group_project_id'), 'user_group', ['project_id'], unique=False)
    ...
    op.create_index(op.f('ix_test_case_log_executed_at'), 'test_case_log', ['executed_at'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_test_case_log_executed_at'), table_name='test_case_log')
    ...
    op.drop_index(op.f('ix_group_permission_permission_id'), table_name='group_permission')
    op.drop_index(op.f('ix_group_permission_org_id'), table_name='group_permission')
    op.drop_index(op.f('ix_group_permission_group_id'), table_name='group_permission')
